...
def parse_opt():
    ...
    parser.add_argument('--img_train', type=str, default='UA-DETRAC/gt/train', help='train images path')
    parser.add_argument('--img_val', type=str, default='UA-DETRAC/gt/test', help='validation images path')
    parser.add_argument('--lbl_train', type=str, default='UA-DETRAC-Annotations/train', help='train labels path')
    parser.add_argument('--lbl_val', type=str, default='UA-DETRAC-Annotations/test', help='validation labels path')
